...
def test_smart_legend_comprehensive():
    ...
    try:
        ...
        all_labels = [plotter._format_result_label(r, varying_params) for r in simulation_results]
        ...
        constant_in_labels = any('solver=3' in label or 'amp_values=0.0022' in label for label in all_labels)
        ...
        print(f"   # Hidden from legend: solver, amp_values, and other constant parameters")
