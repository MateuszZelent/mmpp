...
def test_package_setup():
    ...
    tests = [
        ...
        (
            "python -c \"import mmpp; print(f'Package version: {mmpp.__version__}')\"",
            "Package import test",
        ),
        (
            "python -c \"import mmpp; print(f'Author: {mmpp.__author__}')\"",
            "Package metadata test",
        ),
        (
            "python -c \"import mmpp; print(f'Features: {mmpp.__features__}')\"",
