...
def test_dynamic_title():
    ...
    title = plotter._format_dynamic_title(
        ["amp", "nonexistent", "solver"], mock_results
    )
    print(f"   Generated title: '{title}'")
    ...
    print()
    print(
        "results.matplotlib.plot(x_series='t', y_series='m_z11', title=['amp', 'f0'])"
    )
    print("# Should generate title: 'Amp = 2.20e-03, F0 = 1.00e+09'")
    print()
    print(
        "results.matplotlib.plot(x_series='t', y_series='m_z11', title='Custom Title')"
    )
