...
def create_test_data():
    ...
    z.create_dataset('m_z11-14', data=m_data, chunks=(200, n_z, n_y, n_x, n_comp))  # Alternative name
...
def test_plot_spectrum_interface():
    ...
    try:
        ...
        if np.allclose(result.frequencies, result2.frequencies) and \
           np.allclose(result.spectrum, result2.spectrum):
