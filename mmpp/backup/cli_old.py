...
Modern TUI interface with fallback to traditional CLI.
"""

def main() -> None:
    """Main entry point for the mmpp CLI."""
    # Import and run the modern TUI interface
    from .cli_new import main as tui_main
    return tui_main()
    )
    ...
    if args.command == "info":
        ...
        from .cli.auth import handle_auth_command
        handle_auth_command(args)
    elif args.command == "jobs":
        from .cli.jobs import handle_jobs_command
        handle_jobs_command(args)
    elif args.command == "swap":
        from .cli.swap import handle_swap_command
