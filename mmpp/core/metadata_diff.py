"""
Metadata Diff Utilities

Utilities for comparing simulation metadata across jobs and generating
...
def find_differing_parameters(jobs: list[Any]) -> DiffResult:
    ...
    -------
    DiffResult
        Object containing differing and common parameters
    """
    if not jobs:
        return DiffResult({}, {}, 0)
...
def format_value_with_unit(
    ...
    -------
    str
        Formatted string like "100mT" or "800kA/m"
    """
    if value is None:
        return "N/A"
...
def generate_auto_labels(
    ...
    jobs : list[ZarrJobResult]
        List of job results
    max_params : int, default 3
        Maximum number of parameters to include in label
