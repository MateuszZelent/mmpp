...
class FoldedDispersionResult:
    ...
    _k_array: np.ndarray | None = field(default=None, repr=False)
    _f_array: np.ndarray | None = field(default=None, repr=False)
    _intensity_array: np.ndarray | None = field(default=None, repr=False)
    _origin_array: np.ndarray | None = field(default=None, repr=False)
    ...
    def intensities(self) -> np.ndarray:
        ...
        return (
            self._intensity_array if self._intensity_array is not None else np.array([])
        )
    ...
    def filter_frequency(
        self, f_min: float = 0, f_max: float = np.inf
    ...
    def find_mode_nearest(self, k: float, f: float) -> DispersionMode | None:
        """
    ...
    def find_modes_at_frequency(
        self, f: float, tolerance: float = 0.1e9
    ) -> list[DispersionMode]:
        """
    ...
    def find_modes_at_k(
        self, k: float, tolerance: float | None = None
    ) -> list[DispersionMode]:
        """
