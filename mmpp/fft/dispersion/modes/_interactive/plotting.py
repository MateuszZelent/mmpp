...
class InteractivePlotter:
    ...
    def __init__(self, result: DispersionResult1D):
        ...
        self.colorbar_disp: Any = None
        self.colorbar_mode: Any = None
    ...
    def initialize_figure(
        ...
        assert self.ax_disp is not None and self.ax_mode is not None
    ...
    def update_dispersion_plot(
        ...
        self.colorbar_disp = cast(Any, self.fig).colorbar(
    ...
    def update_mode_visualization(
        ...
        self.colorbar_mode = cast(Any, self.fig).colorbar(
            im, ax=ax, shrink=0.8, pad=0.02
        )
